...
#idadebug_ocaml.c 
IDACPP    = idaside.cpp idaocaml.cpp idashared.cpp idagraphviewer.cpp  idagui_c.cpp
...
# ../Z3/Z3.cmo 
EXTRACPP   = 
# ../Z3/Z3_stubs.o ../Z3/Z3_theory_stubs.o ../Z3/Z3.lib 
...
install: $(OCAMLIDACMO) $(OCAMLIDACMI)
	cp $^ "$(OCAMLLIB)"
...
.c.o:
	cl /I"$(OCAMLLIB)" -c $< /Fo$@
.cpp.o:
	cl /I"$(IDAINCL)" -D__NT__ -D__IDP__ -c $< /Fo$@
